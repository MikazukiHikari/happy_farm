...
public class watermelon extends weather{
	     public int x=12;
		 public int y=4;
		...
		death_counter4=0;
		 ...
		 public void check(int d){
			  switch(d){
		 case 1:
		if(humid_point1>25||humid_point1<15){
				 death_counter1++;
		}else{
			death_counter1=0;}
		 break;
		 case 2:
		if(humid_point2>25||humid_point2<15){
				 death_counter2++;
		}else{
			death_counter2=0;}
		 break;
		 case 3:
		 if(humid_point3>25||humid_point3<15){
				 death_counter3++;
		}else{
			death_counter3=0;}
		 break;
		 case 4:
		if(humid_point4>25||humid_point4<15){
				 death_counter4++;
		}else{
			death_counter4=0;}
		 break;
		 case 5:
		 if(humid_point5>25||humid_point5<15){
				 death_counter5++;
		}else{
			death_counter5=0;}
		 break;
		 case 6:
		 if(humid_point6>25||humid_point6<15){
				 death_counter6++;
		}else{
			death_counter6=0;}
		 break;
		 case 7:
		 if(humid_point7>25||humid_point7<15){
				 death_counter7++;
		}else{
			death_counter7=0;}
		 break;
		 case 8:
		 if(humid_point8>25||humid_point8<15){
				 death_counter8++;
		}else{
			death_counter8=0;}
		 break;
		 case 9:
		 if(humid_point9>25||humid_point9<15){
				 death_counter9++;
		}else{
			death_counter9=0;}
		 break;
